...
func init() {
	data[discordgo.Finnish] = map[string]string{
		"#allow-role":                   "rooli-sallittu",
		"#look":                         "katso",
		"#move":                         "liikkua",
		"#review":                       "arvostelu",
		"#allow-role.value":             "arvo",
		"#.subject":                     "kohde",
		"#look.info":                    "tiedot",
		"#look.review-list":             "tarkista-luettelo",
		"#allow-role.Description":       "Vain järjestelmänvalvoja - Oletus: False",
		"#look.Description":             "nähdä jotain",
		"#move.Description":             "Siirrä arvostelu tälle kanavalle",
		"#review.Description":           "Käyttäjän arvostelu",
		"#allow-role.value.Description": "aseta arvo",
