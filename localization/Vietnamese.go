...
func init() {
	data[discordgo.Vietnamese] = map[string]string{
		"#allow-role":                   "vai-trò-được-phép",
		"#look":                         "nhìn",
		"#move":                         "di-chuyển",
		"#review":                       "ôn-tập",
		"#allow-role.value":             "giá-trị",
		"#.subject":                     "mục-tiêu",
		"#look.info":                    "thông-tin",
		"#look.review-list":             "danh-sách-đánh-giá",
		"#allow-role.Description":       "Chỉ quản trị viên - Mặc định: Sai",
		...
		"#allow-role.value.Description": "Đặt giá trị",
		"#.subject.Description":         "Chọn mục tiêu",
		"#look.info.Description":        "Xem thông tin người dùng",
		"#look.review-list.Description": "Xem danh sách đánh giá người dùng nhận được",
