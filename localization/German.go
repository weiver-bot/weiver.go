...
func init() {
	data[discordgo.German] = map[string]string{
		...
		"#look.review-list":                   "rezension-fliste",
		...
		"#look.review-list.Description":       "Sehen Sie sich eine Liste der von Benutzern erhaltenen Bewertungen an",
		...
		"#allow-role.proc.Description":        "Rolle zulassen",
		...
		"#look.review-list.IsNone":            "Es liegen keine Bewertungen vor",
